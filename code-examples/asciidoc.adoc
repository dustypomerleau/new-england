...
.. next
. but seeing this:
.. perhaps handle globally cuz it's not sticky
...
link:https://eyenotes.org[this page^, role=green]
...
:toc:
:my-url: https://eyenotes.org
:another-url: https://eyenotes.org[this location]
...
// you can also assign roles to quoted text like:
